...
extension UIColor {
    static let appAmber    = UIColor(red: 245/255, green: 166/255, blue: 35/255, alpha: 1)
    static let appAmberDim = UIColor(red: 196/255, green: 125/255, blue: 14/255, alpha: 1)
    static let appDust     = UIColor(red: 58/255,  green: 58/255,  blue: 62/255, alpha: 1)
}
...
enum AppFont {
    /// 大見出し・アプリ名「あしあと」（Nunito ExtraBold 900）
    static func display(_ size: CGFloat) -> Font {
        .custom("Nunito", size: size).weight(.heavy)
    }

    /// セクションタイトル・バッジ・数値強調（Nunito Bold 700）
    static func heading(_ size: CGFloat) -> Font {
        .custom("Nunito", size: size).weight(.bold)
    }

    /// ボタンラベル（Nunito Bold 15pt — 定義書 5.1 準拠）
    static func button() -> Font {
        .custom("Nunito", size: 15).weight(.bold)
    }

    /// 本文・機能説明（Noto Sans JP Regular 400）
...
enum Token {
    ...
    enum Button {
        ...
        static let font            = AppFont.button()
    }
    ...
    enum HistoryCard {
        ...
        static let distFont          = AppFont.heading(20)
